		...
		B:存储自定义对象并遍历
			...
			public class StudentDemo {
				public static void main(String[] args) {
					...
					//创建学生对象
					Student s1 = new Student("德玛西亚",27);
					Student s2 = new Student("艾希",30);
					Student s3 = new Student("盲僧",30);
					Student s4 = new Student("潘森",25);
					Student s5 = new Student("薇恩",16);
